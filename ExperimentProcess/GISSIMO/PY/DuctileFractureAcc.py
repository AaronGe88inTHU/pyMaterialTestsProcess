...
def read_tri_lodeAlt_eps_from_fem(fileName):
    ...
    for sheet in xlsx.sheet_names:
        ...
        '''
        lodeAlt = df.loc[:, 'LODE_ALT'].values.reshape(-1, 1)
...
def fitDamageSimple(tests):
    targets = tests[:, 2]
    #result = testResults(tests,(996.68, 0.026, 0.1, 500))
    res = optimize.least_squares(errSimple, (0.1, 500), bounds=([0,0],[1000,10000]), args=(tests, targets))
    return res
